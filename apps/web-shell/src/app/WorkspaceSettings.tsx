...
interface WorkspaceCenterSurfaceProps {
...
export function WorkspaceCenterSurface({
  settingsOpen,
...
export function WorkspaceSettings({
  ...
  return (
    <section className="workspace-settings" aria-label="설정">
