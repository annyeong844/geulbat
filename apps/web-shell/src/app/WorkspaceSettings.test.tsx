...
// 연결 탭이 더 이상 없다.
void test('WorkspaceSettings owns MCP administration without a connection tab', async () => {
  let closeCount = 0;
...
void test('WorkspaceCenterSurface keeps editor-local state across center overlays', () => {
  let renderer!: ReactTestRenderer;
  act(() => {
