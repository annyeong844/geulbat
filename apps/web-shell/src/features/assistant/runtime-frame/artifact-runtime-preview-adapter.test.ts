...
import { renderArtifactRuntimeFrame } from './artifact-runtime-preview-adapter.js';
...
void test('renderArtifactRuntimeFrame injects the concrete assistant runtime frame', () => {
