...
const BASE_FORBIDDEN_BROWSER_OUTPUT_KEYS = new Set([
  'artifactcandidate',
  'body',
  'browserconsole',
  'browsercontextid',
...
export interface PtcLabBrowserForbiddenOutputKeyOptions {
...
function buildForbiddenKeySet(
  ...
  const keys = new Set(BASE_FORBIDDEN_BROWSER_OUTPUT_KEYS);
