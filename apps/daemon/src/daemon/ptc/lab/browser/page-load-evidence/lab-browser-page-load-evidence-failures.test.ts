...
import type { PtcLabBrowserEvidenceChecks } from '../../../shared/browser-evidence-contract.js';
import {
...
type AdapterChecks = Omit<PtcLabBrowserEvidenceChecks, 'targetVerified'>;
  ...
  await withBrowserPageLoadEvidenceSessionManager(
    {
      ...
      evidenceResult: {
        ...
        stdout: `${JSON.stringify({
          ...
          title: 'Reset token access_token=secret',
