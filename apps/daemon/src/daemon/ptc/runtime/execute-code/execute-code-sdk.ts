...
export function buildPtcExecuteCodeReservedSdkRequireSource(
  ...
  return [
    ...
    '    bindRuntime(geulbat);',
    '    const sdkModule = { sdkVersion: __geulbatSdkProjection.sdkVersion, sdkProjectionHash: __geulbatSdkProjection.sdkProjectionHash };',
    '    Object.defineProperty(sdkModule, module.exportName, { enumerable: true, value: (args = {}) => wrapper(args) });',
