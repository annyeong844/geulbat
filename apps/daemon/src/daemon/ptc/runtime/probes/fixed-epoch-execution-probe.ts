...
import { applyPtcHostPathMode } from '../../lab/session/host-path-mode.js';
import {
...
> {
  ...
  try {
    bridgeResult = await (args.bridgeFactory ?? createPtcSessionEpochBridge)({
      ...
      ...(args.callbackPolicy === undefined
        ? {}
        : { callbackPolicy: args.callbackPolicy }),
